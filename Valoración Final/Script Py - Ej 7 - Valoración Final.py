...
for i in Historial3:
    suma_montos = suma_montos + i

cantidad_elementos = len(Historial3)

promedio_gastos = int(suma_montos / cantidad_elementos)

if promedio_gastos > 4500:
    print(f'Se ha excedido del gasto promedio para su mascota. Su promedio es de: ${promedio_gastos}')
else:
    print(f'Su promedio es de: ${promedio_gastos}')